...
# Ozan Akın, 2309599                                               #
#                                                                  #
# First I added the relative part for making the JMPQ instruction  #
# a valid instruction. Then I added the next_pc calculation to the #
# new_pc part to make JMPQ work.                                   #
#                                                                  #
#                                                                  #
# Explanation for jmpq instruction                                 #
#                                                                  #
